...
$daysWeekRu = ["пн ", "вт ", "ср ", "чт ", "пт ", "суб ", "вскр"];
$daysWeekEn = ['mon ', 'tue ', 'wed ', 'thu ', 'fri ', 'sat ', 'sun'];
...
$value = match ($lang) {
    'ru' => print_r($daysWeekRu),
    'en' => print_r($daysWeekEn),
    default => print_r('Я не знаю такого языка'),
};
